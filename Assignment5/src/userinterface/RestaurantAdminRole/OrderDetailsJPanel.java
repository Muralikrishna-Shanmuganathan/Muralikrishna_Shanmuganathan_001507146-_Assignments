...
public class OrderDetailsJPanel extends javax.swing.JPanel {
    ...
    Order order;
    EcoSystem system;
    public OrderDetailsJPanel(JPanel userProcessContainer, UserAccount account, Order order, EcoSystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 170, -1, 100));
