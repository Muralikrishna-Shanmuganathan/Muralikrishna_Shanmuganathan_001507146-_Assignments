...
public class ManageRestaurants extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblTitle.setText("MANAGE RESTAURANT PORTAL");
        ...
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 40, 120, 30));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (system.getUserAccountDirectory().checkIfUsernameIsUnique(username)==false) {
            ...
            system.getUserAccountDirectory().createUserAccount(name,username,password, null, new AdminRole());
            Restaurant restro= system.getRestaurantDirectory().createRestaurantInfo(username);
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        String username= (String) tblRestaurants.getValueAt(selectedRowIndex, 1);
        String pwd= (String) tblRestaurants.getValueAt(selectedRowIndex, 2);
